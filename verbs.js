const conjugations = {
    ...
    aimer: {
        tenses:{
            ...
            passe_compose: ['j\'ai aimé', 'tu as aimé', 'il/elle a aimé', 'nous avons aimé', 'vous avez aimé', 'ils/elles ont aimé'],
    ...
    chanter: {
        tenses:{
            ...
            passe_compose: ['j\'ai chanté', 'tu as chanté', 'il/elle a chanté', 'nous avons chanté', 'vous avez chanté', 'ils/elles ont chanté'],
    ...
    danser: {
        tenses:{
            ...
            passe_compose: ['j\'ai dansé', 'tu as dansé', 'il/elle a dansé', 'nous avons dansé', 'vous avez dansé', 'ils/elles ont dansé'],
    ...
    voyager: {
        tenses:{
            ...
            passe_compose: ['j\'ai voyagé', 'tu as voyagé', 'il/elle a voyagé', 'nous avons voyagé', 'vous avez voyagé', 'ils/elles ont voyagé'],
    ...
    travailler: {
        tenses:{
            ...
            passe_compose: ['j\'ai travaillé', 'tu as travaillé', 'il/elle a travaillé', 'nous avons travaillé', 'vous avez travaillé', 'ils/elles ont travaillé'],
    ...
    écouter: {
        tenses:{
            ...
            passe_compose: ['j\'ai écouté', 'tu as écouté', 'il/elle a écouté', 'nous avons écouté', 'vous avez écouté', 'ils/elles ont écouté'],
    ...
    étudier: {
        tenses:{
            ...
            passe_compose: ['j\'ai étudié', 'tu as étudié', 'il/elle a étudié', 'nous avons étudié', 'vous avez étudié', 'ils/elles ont étudié'],
    ...
    jouer: {
        tenses:{
            ...
            passe_compose: ['j\'ai joué', 'tu as joué', 'il/elle a joué', 'nous avons joué', 'vous avez joué', 'ils/elles ont joué'],
    ...
    regarder: {
        tenses:{
            ...
            passe_compose: ['j\'ai regardé', 'tu as regardé', 'il/elle a regardé', 'nous avons regardé', 'vous avez regardé', 'ils/elles ont regardé'],
    ...
    nager: {
        tenses:{
            ...
            passe_compose: ['j\'ai nagé', 'tu as nagé', 'il/elle a nagé', 'nous avons nagé', 'vous avez nagé', 'ils/elles ont nagé'],
    ...
    manger: {
        tenses:{
            ...
            passe_compose: ['j\'ai mangé', 'tu as mangé', 'il/elle a mangé', 'nous avons mangé', 'vous avez mangé', 'ils/elles ont mangé'],
    ...
    attendre: {
        tenses:{
            ...
            passe_compose: ['j\'ai attendu', 'tu as attendu', 'il/elle a attendu', 'nous avons attendu', 'vous avez attendu', 'ils/elles ont attendu'],
    ...
    entendre: {
        tenses:{
            ...
            passe_compose: ['j\'ai entendu', 'tu as entendu', 'il/elle a entendu', 'nous avons entendu', 'vous avez entendu', 'ils/elles ont entendu'],
    ...
    perdre: {
        tenses:{
            ...
            passe_compose: ['j\'ai perdu', 'tu as perdu', 'il/elle a perdu', 'nous avons perdu', 'vous avez perdu', 'ils/elles ont perdu'],
    ...
    rendre: {
        tenses:{
            ...
            passe_compose: ['j\'ai rendu', 'tu as rendu', 'il/elle a rendu', 'nous avons rendu', 'vous avez rendu', 'ils/elles ont rendu'],
    ...
    répondre: {
        tenses:{
            ...
            passe_compose: ['j\'ai répondu', 'tu as répondu', 'il/elle a répondu', 'nous avons répondu', 'vous avez répondu', 'ils/elles ont répondu'],
    ...
    descendre: {
        tenses:{
            ...
            passe_compose: ['je suis descendu(e)', 'tu es descendu(e)', 'il/elle est descendu(e)', 'nous sommes descendu(e)s', 'vous êtes descendu(e)(s)', 'ils/elles sont descendu(e)s'],
    ...
    défendre: {
        tenses:{
            ...
            passe_compose: ['j\'ai défendu', 'tu as défendu', 'il/elle a défendu', 'nous avons défendu', 'vous avez défendu', 'ils/elles ont défendu'],
    ...
    prétendre: {
        tenses:{
            ...
            passe_compose: ['j\'ai prétendu', 'tu as prétendu', 'il/elle a prétendu', 'nous avons prétendu', 'vous avez prétendu', 'ils/elles ont prétendu'],
    ...
    confondre: {
        tenses:{
            ...
            passe_compose: ['j\'ai confondu', 'tu as confondu', 'il/elle a confondu', 'nous avons confondu', 'vous avez confondu', 'ils/elles ont confondu'],
    ...
    correspondre: {
        tenses:{
            ...
            passe_compose: ['j\'ai correspondu', 'tu as correspondu', 'il/elle a correspondu', 'nous avons correspondu', 'vous avez correspondu', 'ils/elles ont correspondu'],
    ...
    choisir: {
        tenses:{
            ...
            passe_compose: ['j\'ai choisi', 'tu as choisi', 'il/elle a choisi', 'nous avons choisi', 'vous avez choisi', 'ils/elles ont choisi'],
    ...
    réussir: {
        tenses:{
            ...
            passe_compose: ['j\'ai réussi', 'tu as réussi', 'il/elle a réussi', 'nous avons réussi', 'vous avez réussi', 'ils/elles ont réussi'],
    ...
    grandir: {
        tenses:{
            ...
            passe_compose: ['j\'ai grandi', 'tu as grandi', 'il/elle a grandi', 'nous avons grandi', 'vous avez grandi', 'ils/elles ont grandi'],
    ...
    rougir: {
        tenses:{
            ...
            passe_compose: ['j\'ai rougi', 'tu as rougi', 'il/elle a rougi', 'nous avons rougi', 'vous avez rougi', 'ils/elles ont rougi'],
    ...
    remplir: {
        tenses:{
            ...
            passe_compose: ['j\'ai rempli', 'tu as rempli', 'il/elle a rempli', 'nous avons rempli', 'vous avez rempli', 'ils/elles ont rempli'],
    ...
    obéir: {
        tenses:{
            ...
            passe_compose: ['j\'ai obéi', 'tu as obéi', 'il/elle a obéi', 'nous avons obéi', 'vous avez obéi', 'ils/elles ont obéi'],
    ...
    batir: {
        tenses:{
            ...
            passe_compose: ['j\'ai bâti', 'tu as bâti', 'il/elle a bâti', 'nous avons bâti', 'vous avez bâti', 'ils/elles ont bâti'],
    ...
    guérir: {
        tenses:{
            ...
            passe_compose: ['j\'ai guéri', 'tu as guéri', 'il/elle a guéri', 'nous avons guéri', 'vous avez guéri', 'ils/elles ont guéri'],
    ...
    réfléchir: {
        tenses:{
            ...
            passe_compose: ['j\'ai réfléchi', 'tu as réfléchi', 'il/elle a réfléchi', 'nous avons réfléchi', 'vous avez réfléchi', 'ils/elles ont réfléchi'],
