...
var regularVerbData = {
    ...
    "ir":{
        "pastImperfect":["iss(ais)","iss(ais)","iss(ait)","iss(ait)","iss(ions)","iss(iez)","iss(aient)","iss(aient)"],
...
{   
    "inf": "abolir",
    "english": {"inf":"to abolish","pastImperfect":"[was/were] abolishing","present":"[am/are/is] abolishing","futureSimple":"will abolish","conditional":"would abolish"},
    "end": "ir",
    "type": "regular",
    "base": {"pastImperfect":"abol","present":"abol","futureSimple":"abolir","conditional":"abolir"}},
{   
    "inf": "agir",
    "english": {"inf":"to act","pastImperfect":"[was/were] acting","present":"[am/are/is] acting","futureSimple":"will act","conditional":"would act"},
    "end": "ir",
    "type": "regular",
    "base": {"pastImperfect":"ag","present":"ag","futureSimple":"agir","conditional":"agir"}},
{   
    "inf": "avertir",
    ...
    "end": "ir",
    "type": "regular",
    "base": {"pastImperfect":"avert","present":"avert","futureSimple":"avertir","conditional":"avertir"}},
{   
    "inf": "choisir",
    ...
    "end": "ir",
    "type": "regular",
    "base": {"pastImperfect":"chois","present":"chois","futureSimple":"choisir","conditional":"choisir"}},

{   
    "inf": "établir",
    "english": {"inf":"to establish","pastImperfect":"[was/were] establishing","present":"[am/are/is] establishing","futureSimple":"will establish","conditional":"would establish"},
    "end": "ir",
    "type": "regular",
    "base": {"pastImperfect":"établ","present":"établ","futureSimple":"établir","conditional":"établir"}},
...
{   
    ...
    "end": "ir",
    "type": "regular",
    "base": {"pastImperfect":"fin","present":"fin","futureSimple":"finir","conditional":"finir"}},
{   
    "inf": "investir",
    ...
    "end": "ir",
    "type": "regular",
    "base": {"pastImperfect":"invest","present":"invest","futureSimple":"investir","conditional":"investir"}},
{   
    "inf": "nourrir",
    ...
    "end": "ir",
    "type": "regular",
    "base": {"pastImperfect":"nourr","present":"nourr","futureSimple":"nourrir","conditional":"nourrir"}},
{   
    "inf": "punir",
    ...
    "end": "ir",
    "type": "regular",
    "base": {"pastImperfect":"pun","present":"pun","futureSimple":"punir","conditional":"punir"}},    
{   
    "inf": "réfléchir",
    ...
    "end": "ir",
    "type": "regular",
    "base": {"pastImperfect":"réfléch","present":"réfléch","futureSimple":"réfléchir","conditional":"réfléchir"}},        
{   
    "inf": "attendre",
...
{   
    ...
    "present": [ "ois","ois","oit","oit","evons","evez","oivient","oivent" ],
